...
public class EntityImportTest extends BaseTest {
    ...
    @Test
    public void filteredImport2Button() {
    ...
    @Test
    public void filteredImport3Button() {
    ...
    @Test
    public void selectForEmbededButton() throws InterruptedException{
    ...
    @Test
    public void selectForEmbededCustomButton() throws InterruptedException{
